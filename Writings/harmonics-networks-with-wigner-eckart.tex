...
\begin{equation*}
p_m(f) = \langle f, \cos_m \rangle \cos_m + \langle f, \sin_m \rangle \sin_m.
\end{equation*}
Then, since $V_n$ appears only once in $L^2(S^1)$, by the Wigner-Eckart Theorem \ref{Wigner-Eckart} we obtain that there is a unique endomorphism $f_{a, b}$ of $V_n$ such th
\end{proof}
