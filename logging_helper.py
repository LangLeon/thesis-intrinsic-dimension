...
def log_results(epochs, train_losses, train_accuracies, val_losses, val_accuracies, subspace_distances, ARGS):
    ...
    file_name = "N_{}_flips_{}_d_dim_{}_lr_{}_gamma_{}_sched_freq_{}_seed_{}_epochs_{}_batchsize_{}.csv".format(ARGS.N, ARGS.flips, ARGS.d_dim, ARGS.lr, ARGS.schedule_gamma, ARGS.schedule_freq, ARGS.seed, ARGS.n_epochs, ARGS.batch_size)
